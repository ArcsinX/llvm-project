...
public:
  ...
  struct ASTListener {
    ...
    /// are set up, but before clangd installs its PPCallbacks. Modules should
    /// only use this when their callbacks must observe preamble events replayed
    /// during a main-file build.
